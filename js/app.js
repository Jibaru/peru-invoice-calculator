...
addLineForm?.addEventListener("submit", (e) => {
    ...
    if (addLineForm instanceof HTMLFormElement) {
        ...
        const lineItem = new LineItem(values.name, values.quantity, values.startingUnitPrice, values.isc, values.igv, values.rc, values.startingDiscount, values.baseGlobalDiscount);
